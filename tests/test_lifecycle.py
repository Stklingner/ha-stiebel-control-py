...
class TestApplicationContext:
    ...
    def test_application_context(self):
        ...
        assert context.get_component("test_component") == component
...
class TestCanIntegration:
    ...
    def test_can_interface_integration(self):
        ...
        try:
            ...
            assert controller.app_context.get_component("can_interface") == mock_can_interface
            ...
            assert mock_can_interface.start.called
            
            # Now stop the controller
            controller.stop()
            
            # Verify stop was called on the can_interface
            assert mock_can_interface.stop.called
